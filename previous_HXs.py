...
heat_exchanger_data = [
    ...
    [16,7,0.195,14e-3,False, 2, 2], # 2025C
    [12,8,0.26,14e-3,True, 2, 2],  # 2025D
    [12,6,0.262,14e-3,True, 2, 2],  # 2025E
...
experimental_data = [
    ...
    # --- 2022 data ---
    [19.4, 25.3, 0.252e5, 55.4, 50.0, 0.074e5, 10.38, 0.408, 0.483],
    [20.8, 24.9, 0.116e5, 53.8, 48.8, 0.070e5, 9.62, 0.542, 0.486],
    [22.0, 26.3, 0.135e5, 51.5, 46.1, 0.140e5, 9.67, 0.542, 0.434], 
    [23.0, 27.0, 0.142e5, 51.0, 45.1, 0.170e5, 9.41, 0.533, 0.410],
    [24.1, 28.0, 0.169e5, 48.8, 43.9, 0.155e5, 8.26, 0.500, 0.417],
    [25.0, 28.9, 0.277e5, 48.1, 42.4, 0.246e5, 7.82, 0.467, 0.344],
]
