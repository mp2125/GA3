...
heat_exchanger_data = [
    ...
    [14,10,0.25,None,False, 2, 1], #2023A
    [16, 6,0.194,None,False, 4, 2], #2023B 
    # [18,12,0.160,14e-3,False, 4, 2], #2023C - Very anomolous result (supposedly no leaks?!?)
    [10,8,0.246,None,False, 2, 1], #2023D
    [12,11,0.261,None,False, 2, 1], #2023E

    # [14,13,0.236,None,False, 1, 1], #2022A
    # [16,6,0.219,None,False, 1, 1], #2022B
    # # [20,4,0.174,12e-3,False, 2, 1], #2024C
    # [12,8,0.259,None,False,2,1], # 2022D
    # [24,4,0.145,None,False, 4, 1], #2022E
    # [20,6,0.172,None,False, 4, 2], #2022F
