...
# calculated pitches
group_d1 = HX(10, 11, 0.243, tube_pitch=None, is_square_layout=False, tube_passes=2, shell_passes=2)
group_d2 = HX(8, 12, 0.281, tube_pitch=None, is_square_layout=False, tube_passes=2, shell_passes=2)
group_b = HX(16, 7, 0.174, tube_pitch=None, is_square_layout=False, tube_passes=4, shell_passes=2)
group_a = HX(12, 14, 0.236, tube_pitch=None, is_square_layout=False, tube_passes=2, shell_passes=1)
group_c = HX(12, 7, 0.230, tube_pitch=None, is_square_layout=False, tube_passes=2, shell_passes=2)
group_e = HX(16, 8, 0.185, tube_pitch=None, is_square_layout=False, tube_passes=2, shell_passes=1)
